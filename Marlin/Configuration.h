...
#define STRING_CONFIG_H_AUTHOR "(MoellerDi, Tronxy X5S w/ MKS SBASE)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 0 // via P0_2 P0_3 (AUX1)

/**
 * Select a secondary serial port on the board to use for communication with the host.
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 //via USB
...
#define TEMP_SENSOR_CHAMBER 501
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //e3D V6 upgraded to Volcano Clone; PSU at 13V (tuned with "M303 E0 S210 C10")
  #define DEFAULT_Kp 17.77
  #define DEFAULT_Ki 1.73
  #define DEFAULT_Kd 45.54
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Tronxy X5S Stock Bed; PSU at 13V (tuned with "M303 E-1 S70 C10")
  #define DEFAULT_bedKp 384.53
  #define DEFAULT_bedKi 21.83
  #define DEFAULT_bedKd 1693.61
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 820 }
...
//                   ....(in steps/s)  40000 40000 12000 41000 @ 32 microsteps
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN P1_25       // Use X_MAX_PIN
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 120      // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
