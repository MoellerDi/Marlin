...
#define STRING_CONFIG_H_AUTHOR "(Creality CR-10 MKS Gen 1.4)" // Who made the changes.
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -45 //46.4 // X offset: -left  +right  [of the nozzle]
