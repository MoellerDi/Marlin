...
#define STRING_CONFIG_H_AUTHOR "(MoellerDi, Creality CR-10 w/ MKS Gen 1.4 and BLTouch)" // Who made the changes.
...
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 25, 100 } // testing
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
//#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 10000 } //default conf
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -46 //46.4 // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -3  //5.5  // Y offset: -front +behind [the nozzle]
