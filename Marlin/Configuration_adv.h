...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { { 0, (Y_BED_SIZE / 2) }, { 285, (Y_BED_SIZE / 2) } }
...
#define DISABLE_MULTI_STEPPING // Disable multiple steps per ISR
...
//#define ENCODER_RATE_MULTIPLIER
  ...
  //#define ENCODER_RATE_MULTIPLIER_DEBUG   // output the encoder steps per second value
#endif
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 7.0              // (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP 7.0         // (mm) Default swap retract length (positive value)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH     1025  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   965  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
...
//#define NO_VOLUMETRICS
  ...
  #define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT 5.00      // (mm^3/sec)
  #endif
#endif
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Store Fil E1"
  #define USER_GCODE_1 "T0\nG92 E0\nG1 E-5 F10000\nG92 E0\nG1 E2 F10000\nG92 E0\nG1 E-747 F10000\nG92 E0\nT0"

  #define USER_DESC_2 "Store Fil E2"
  #define USER_GCODE_2 "T1\nG92 E0\nG1 E-5 F10000\nG92 E0\nG1 E2 F10000\nG92 E0\nG1 E-747 F10000\nG92 E0\nT0"

  #define USER_DESC_3 "Un-store Fil E1"
  #define USER_GCODE_3 "T0\nG92 E0\nG1 E750 F10000\nG92 E0\nT0"

  #define USER_DESC_4 "Un-store Fil E2"
